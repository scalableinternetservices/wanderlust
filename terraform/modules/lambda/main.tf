...
# Lambda URIs are "{+lambda}/{+function}" e.g. "wanderlust/ping".
# We also support path matching at the root e.g. "wanderlust" but these require definining separate "_root" terraform resources.
