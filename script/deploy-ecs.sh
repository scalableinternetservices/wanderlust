...
usage="Usage: deploy-ecs.sh [wanderlust-app-web|wanderlust-app-background] [sha]"
...
new_image="101624687637.dkr.ecr.us-west-2.amazonaws.com/wanderlust:$2"
...
aws ecs update-service --cluster wanderlust \
  --no-cli-pager \
  --region "$ecs_region" \
